...
export default function OverviewTab({ stats, onNavigate }: OverviewTabProps) {
    if (!stats) return (
        <div className="flex flex-col items-center justify-center p-20 text-ink-tertiary animate-pulse">
        ...
        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
            ...
            <div className="bg-gradient-to-r from-teal-500 to-emerald-500 p-6 rounded-3xl shadow-2xl text-white">
                <div className="flex items-center justify-between">
                    ...
                    <a
                        href="/dispatch"
                        target="_blank"
                        className="px-8 py-4 bg-surface-elevated text-accent-400 rounded-2xl font-black uppercase tracking-widest text-sm shadow-lg hover:shadow-xl hover:scale-105 transition-all">
                        Open Dispatch →
                    </a>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div className="bg-surface-elevated p-6 rounded-4xl border border-border-primary shadow-xl flex items-center justify-between group hover:border-[#e11d48] transition-all">
                    ...
                    <Link href="/campaigns/new" className="px-4 py-2 bg-ink-primary text-white rounded-xl font-black uppercase tracking-widest text-[9px] hover:bg-[#e11d48] transition-all">Launch</Link>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 p-1">
                ...
                <div className="bg-surface-elevated rounded-[2.5rem] p-8 border border-border-primary shadow-xl flex flex-col justify-between">
                    <div>
                        <h3 className="text-lg font-black text-ink-primary uppercase tracking-widest mb-6">Neural Health Insights</h3>
                        <div className="space-y-4">
                            <div className="flex items-center justify-between">
                                <span className="text-[10px] font-bold text-ink-tertiary uppercase tracking-widest">Active Ad Coverage</span>
                                <span className="text-xs font-black text-emerald-400">85% Optimal</span>
                            </div>
                            <div className="h-2 w-full bg-surface-secondary rounded-full overflow-hidden">
                                <div className="h-full bg-emerald-500/100 w-[85%]" />
                            </div>
                            <div className="flex items-center justify-between">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                >
                    ...
                    <div className="mt-3 flex gap-3 border-t border-border-primary pt-3">
                        <div>
                            <p className="text-[8px] font-black text-ink-tertiary uppercase tracking-widest mb-0.5">Active</p>
                ...
                >
                    <div className="flex justify-between items-start mb-2">
                        <div className="p-2 rounded-xl bg-accent-500/10 text-accent-400 group-hover:bg-accent-500/100 group-hover:text-white transition-all">
                            <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" />
                            </svg>
                        </div>
                        <span className="text-[8px] font-black bg-accent-500/15 text-accent-500 px-1.5 py-0.5 rounded-full uppercase tracking-tighter">Marketplace</span>
                    </div>
                    <div className="text-2xl font-black text-ink-primary mb-0.5">{stores.total.toLocaleString()}</div>
                    <div className="text-[10px] font-bold text-ink-tertiary uppercase tracking-widest leading-none">Active Stores</div>
                    <div className="mt-3 flex gap-3 border-t border-border-primary pt-3">
                        <div>
                            <p className="text-[8px] font-black text-ink-tertiary uppercase tracking-widest mb-0.5">Live</p>
                ...
                >
                    <div className="flex justify-between items-start mb-2">
                        <div className="p-2 rounded-xl bg-sand-500/5 text-sand-500 group-hover:bg-accent-500/100 group-hover:text-white transition-all">
                            <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6" />
                            </svg>
                        </div>
                        <span className="text-[8px] font-black bg-sand-500/10 text-sand-500 px-1.5 py-0.5 rounded-full uppercase tracking-tighter">Fundraising</span>
                    </div>
                    <div className="text-2xl font-black text-ink-primary mb-0.5">
                        {(stats.campaigns_count ?? listings.filter((l: any) => l.type === 'campaign').reduce((acc: number, curr: any) => acc + parseInt(curr.count), 0)) || '-'}
                    </div>
                    <div className="text-[10px] font-bold text-ink-tertiary uppercase tracking-widest leading-none">Campaign Hub</div>
                    <div className="mt-3 flex gap-3 border-t border-border-primary pt-3">
                        <div>
                            <p className="text-[8px] font-black text-ink-tertiary uppercase tracking-widest mb-0.5">Growth</p>
                ...
                >
                    <div className="flex justify-between items-start mb-2">
                        <div className="p-2 rounded-xl bg-green-50 text-green-600 group-hover:bg-accent-500/100 group-hover:text-white transition-all">
                            <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <div className="text-2xl font-black text-accent-400 mb-0.5">
                ...
                <div className="bg-surface-elevated p-8 rounded-[2.5rem] shadow-xl shadow-black/10/50 border border-border-primary">
                    <div className="flex justify-between items-center mb-6">
                        ...
                        <div className="flex gap-2">
                            <span className="w-3 h-3 rounded-full bg-accent-500/100"></span>
                            <span className="text-[10px] font-black text-ink-tertiary uppercase tracking-widest">30 Day Volume</span>
                        </div>
                    </div>
                    <div className="h-72">
                        <Line
                ...
                <div className="bg-surface-elevated p-8 rounded-[2.5rem] shadow-xl shadow-black/10/50 border border-border-primary">
                    ...
                    <div className="h-72 flex flex-col items-center justify-center">
                        {listings.length > 0 ? (
                            ...
                            <div className="text-ink-tertiary font-bold uppercase tracking-widest italic text-center">No Data available</div>
                        )}
                    </div>
                </div>
            </div>
            ...
            <div className="bg-surface-elevated p-8 rounded-[2.5rem] shadow-xl shadow-black/10/50 border border-border-primary mt-8">
                <div className="flex justify-between items-center mb-6">
                    <div>
                        <h3 className="text-xl font-black text-ink-primary tracking-tight">System Activity Log</h3>
                        <p className="text-sm font-medium text-ink-tertiary italic">Live administrative pulse</p>
                    </div>
                    <button
                        ...
                        <div className="bg-[#14b8a6] p-8 rounded-[3rem] text-white shadow-2xl relative overflow-hidden group">
                            ...
                            <div className="bg-surface-elevated/10 backdrop-blur-xl rounded-4xl p-6 border border-white/20">
                                ...
                                <div className="flex flex-col xl:flex-row gap-4 justify-between items-center mt-4">
                                    ...
                                    <div className="flex items-center justify-center gap-3 bg-surface-elevated/5 px-3 py-1.5 rounded-xl border border-white/10 w-full xl:w-auto">
                                        <span className="text-[8px] font-black uppercase tracking-widest text-[#a5b4fc] whitespace-nowrap">Priority</span>
                                        <input
                        ...
                        <div className="bg-surface-elevated p-8 rounded-[3rem] border border-border-primary shadow-xl shadow-black/10/50">
                            <div className="flex justify-between items-center mb-6">
                                ...
                                <button
                                    ...
                                    className="px-4 py-2 bg-accent-500 text-white rounded-xl text-[10px] font-black uppercase tracking-widest shadow-lg shadow-accent-500/10"
                                >
                                    + New Asset
                                </button>
                            </div>
                            <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                                ...
                                {(!promoBanners || promoBanners.length === 0) && (
                                    <div className="col-span-full text-ink-tertiary text-[10px] font-medium text-center py-4 bg-surface-secondary/50 rounded-2xl border border-dashed border-border-primary">
                                ...
                                {(promoBanners || []).map(banner => (
                                    <div
                                        ...
                                        className={`aspect-video bg-ink-primary rounded-2xl relative overflow-hidden group border-2 transition-all cursor-pointer ${banner.is_active ? 'border-teal-500 shadow-xl shadow-accent-500/20' : 'border-transparent hover:border-border-primary'}`}
                                    >
                                        ...
                                        <div className="absolute inset-0" style={{ background: 'linear-gradient(to top, rgba(0,0,0,0.8) 0%, transparent 50%)' }}></div>
                                        ...
                                        <div className="absolute bottom-4 left-4 right-4">
                                            <div className="flex justify-between items-end">
                                                <div>
                                                    ...
                                                    <h4 className={`text-sm font-bold leading-tight ${banner.is_active ? 'text-white' : 'text-ink-tertiary'}`}>
                                                        {banner.title}
                                                    </h4>
                                                </div>
                                                <div className={`w-3 h-3 rounded-full ${banner.is_active ? 'bg-accent-500/100 shadow-[0_0_8px_rgba(20,184,166,0.6)] animate-pulse' : 'bg-surface-tertiary'}`}></div>
                                            </div>
                                        </div>
                                        ...
                                        <div className="absolute top-2 right-2 flex gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                                            <button
                                                ...
                                                className="p-1.5 bg-surface-elevated/10 hover:bg-surface-elevated/20 text-white rounded-lg backdrop-blur-sm transition-colors"
                                                title="Edit"
                                            >
                                                ✏️
                                            </button>
                    ...
                    <div className="bg-ink-primary p-8 rounded-[3.5rem] text-white shadow-2xl relative overflow-hidden">
                        ...
                        <div className="mt-12 pt-8 border-t border-white/10">
                            <button
                                ...
                                className="w-full py-4 bg-surface-elevated/5 hover:bg-surface-elevated/10 text-[10px] font-black uppercase tracking-widest rounded-2xl border border-white/5 transition-all text-center"
                            >
