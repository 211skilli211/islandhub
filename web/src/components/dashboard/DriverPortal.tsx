                                    ...
                                    <div className="flex items-center gap-6">
                                        ...
                                        <div>
                                            <h4 className="font-black text-ink-primary text-lg">
                                                {typeof job.title === 'object' && job.title ? ((job.title as { display?: string }).display || 'Market Job') : String(job.title ?? 'Market Job')}
                                            </h4>
                                    ...
                                    <div className="flex justify-between items-start">
                                        <div>
                                            ...
                                            <h4 className="text-3xl font-black italic uppercase tracking-tighter">
                                                {typeof job.title === 'object' && job.title ? ((job.title as { display?: string }).display || 'Job') : String(job.title ?? 'Job')}
                                            </h4>
                                        </div>
                                        <div className="text-right">
