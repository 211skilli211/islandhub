...
export default function MarketplaceHero({ onSearch }: MarketplaceHeroProps) {
    ...
    const colorMap: any = {
        ...
        indigo: { bg: 'from-indigo-500/10 to-violet-500/10', text: 'text-[#818cf8]', btn: 'hover:bg-indigo-400' },
        ...
        >
            <div className="relative z-10 w-full">
                <motion.div
                    ...
                    className={`inline-block px-4 py-1.5 bg-surface-elevated/5 backdrop-blur-xl border border-white/10 rounded-full ${theme.text} text-[10px] font-black uppercase tracking-[0.3em] mb-8 shadow-lg`}
                >
                ...
                <motion.p
                    ...
                    className="text-ink-tertiary text-lg md:text-xl max-w-2xl mx-auto mb-16 font-medium leading-relaxed"
                >
