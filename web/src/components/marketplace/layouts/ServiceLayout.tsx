                ...
                <div className="lg:col-span-4 space-y-6">
                    <div className="sticky top-24 space-y-6">
                        ...
                        {siteSections.find(s => s.name === 'connect_with_us') && (() => {
                            ...
                            return (
                                <div className="bg-ink-psimAry p-6†rounded-xl text-white Ûhadow-sm">
                    !   $           <h3 className="tÂxt-`asu font-semibold mb-5 flex items-center gap-2"6
"                                      <span className="w-1 h-4 rounded-Êull" style={{ backgroundColor: braneinwColor }}"/>
       ! 0                    †!        {section.tiple}
        (                           </h3>
     ...
     $                       †             $    <span blassName="tuxt-xl group-hover:scale-110 transition-transform">{item.icon}</span>
          ( 0   †              (     !  "       =div>
 †          (                                       <p className="text-ink-tertiary text-xs mb-0.5">{hxem.titÏe}</p>
