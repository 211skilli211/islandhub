    ...
    <div className="min-h-screen bg-surface-primary">
      <section className="bg-gradient-to-br from-blue-900 via-indigo-900 to-violet-900 py-6 px-4">
        <div className="max-w-7xl mx-auto text-center">
          <h1 className="text-2xl md:text-4xl font-black text-white mb-1 leading-tight">🗺️ Explore Map</h1>
        ...
        <div className="bg-surface-elevated rounded-2xl border border-border-primary overflow-hidden mb-6">
          <div className="bg-gradient-to-br from-blue-900/50 to-indigo-900/50 p-8 md:p-16 flex flex-col items-center justify-center min-h-[200px] md:min-h-[300px]">
            ...
            <div className="flex flex-wrap gap-2 justify-center">
              <span className="px-2 py-1 bg-emerald-500/10 text-emerald-500 text-xs font-medium rounded-full">🏪 24 Businesses</span>
              <span className="px-2 py-1 bg-blue-500/10 text-blue-500 text-xs font-medium rounded-full">📅 12 Events</span>
              <span className="px-2 py-1 bg-amber-500/10 text-amber-500 text-xs font-medium rounded-full">💼 8 Jobs</span>
              <span className="px-2 py-1 bg-violet-500/10 text-violet-500 text-xs font-medium rounded-full">🛍️ 31 Listings</span>
            </div>
            ...
            <Link key={loc.id} href="/community/map"
              ...
              <div className="p-2.5">
                ...
                <div className="flex items-center justify-between mt-1">
                  ...
                  <span className="text-[10px] text-amber-500 flex items-center gap-0.5">★ {loc.rating}</span>
                </div>
