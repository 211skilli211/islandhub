...
const adminNavItems = [
    ...
    { id: 'campaigns', label: 'Campaigns', icon: '📢', href: '/admin/campaigns/pending' },
    { id: 'broadcast', label: 'Broadcast', icon: '📡', href: '/admin?tab=broadcast' },
    { id: 'compliance', label: 'Compliance', icon: '✅', href: '/admin?tab=compliance' },
            ...
            <aside className={`fixed left-0 top-0 h-screen bg-slate-900 text-white flex flex-col transition-all duration-300 z-50 ${
                ...
                <div className="p-4 border-b border-slate-800 flex items-center justify-between">
                    <Link href="/admin" className="flex items-center gap-3">
                        ...
                        {!collapsed && <span className="font-black text-lg tracking-tight">Admin Panel</span>}
                    </Link>
                ...
                <div className="p-3 border-b border-slate-800">
                    <Link href="/" className="flex items-center gap-2 text-slate-400 hover:text-white text-sm">
                        <span>←</span>
