    ...
    return (
        <div className="max-w-6xl mx-auto space-y-6">
            ...
            <div className="flex flex-wrap gap-2">
                ...
                <button className="px-4 py-2 bg-surface-secondary dark:bg-surface-tertiary text-ink-secondary dark:text-ink-tertiary rounded-xl font-bold text-sm hover:bg-accent-500 hover:text-white transition-all">Businesses</button>
                <button className="px-4 py-2 bg-surface-secondary dark:bg-surface-tertiary text-ink-secondary dark:text-ink-tertiary rounded-xl font-bold text-sm hover:bg-accent-500 hover:text-white transition-all">Events</button>
                <button className="px-4 py-2 bg-surface-secondary dark:bg-surface-tertiary text-ink-secondary dark:text-ink-tertiary rounded-xl font-bold text-sm hover:bg-accent-500 hover:text-white transition-all">Listings</button>
                <button className="px-4 py-2 bg-surface-secondary dark:bg-surface-tertiary text-ink-secondary dark:text-ink-tertiary rounded-xl font-bold text-sm hover:bg-accent-500 hover:text-white transition-all">Jobs</button>
            </div>
            ...
            <div className="bg-surface-secondary dark:bg-surface-tertiary rounded-2xl p-12 flex items-center justify-center min-h-[400px]">
                <div className="text-center">
                    <MapPin className="w-16 h-16 mx-auto text-ink-tertiary dark:text-ink-secondary mb-4" />
