    ...
    return (
        <div className="max-w-6xl mx-auto space-y-6">
            ...
            <div className="flex items-center gap-2">
                <span className="px-3 py-1 bg-[#e11d48]/10 dark:bg-rose-900 text-rose-700 dark:text-rose-300 text-xs font-bold rounded-full flex items-center gap-1">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {liveAuctions.map((auction) => (
                    <div key={auction.id} className="bg-surface-elevated dark:bg-surface-tertiary rounded-2xl overflow-hidden border border-border-primary dark:border-slate-700">
                        <div className="aspect-square bg-surface-secondary dark:bg-slate-700 relative">
                        ...
                        <div className="p-4">
                            ...
                            <div className="flex items-center justify-between mt-3">
                                <div>
                                    ...
                                    <p className="font-black text-accent-400 dark:text-teal-400">${auction.currentBid}</p>
                                </div>
                                <div className="text-right">
                                    <p className="text-xs text-ink-tertiary dark:text-ink-tertiary">Time Left</p>
                                    <p className="font-bold text-ink-secondary dark:text-slate-300 flex items-center gap-1">
                                        <Clock className="w-3 h-3" />
                                        {auction.timeLeft}
                                    </p>
                                </div>
                            </div>
                            <div className="flex items-center justify-between mt-3 pt-3 border-t border-border-primary dark:border-slate-700">
