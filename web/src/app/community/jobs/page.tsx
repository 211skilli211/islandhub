                    ...
                    <div key={idx} className="bg-surface-elevated dark:bg-surface-tertiary rounded-2xl p-6 border border-border-primary dark:border-border-primary hover:border-teal-500 transition-all cursor-pointer">
                        <div className="flex items-start justify-between">
                            <div className="flex items-center gap-4">
                                <div className="w-12 h-12 bg-surface-secondary dark:bg-surface-tertiary rounded-xl flex items-center justify-center">
                            ...
                            <span className="px-3 py-1 bg-accent-500/15 dark:bg-accent-800 text-accent-500 dark:text-accent-300 text-xs font-bold rounded-full">{job.type}</span>
                        </div>
