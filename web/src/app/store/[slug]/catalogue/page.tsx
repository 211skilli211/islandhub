...
function StoreCatalogueContent() {
        ...
        return (
            <div className="min-h-screen bg-slate-50 flex items-center justify-center">
                <div className="text-center">
                    ...
                    <a href="/stores" className="text-teal-600 font-medium">Browse Stores</a>
                </div>
            </div>
        );
    }
    ...
    return (
        <div className="min-h-screen bg-slate-50">
            {/* Store Header Bar */}
            <div className="bg-white border-b border-slate-200 sticky top-[var(--navbar-height,72px)] z-30">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 py-4">
                    <div className="flex flex-col sm:flex-row sm:items-center gap-4">
                        ...
                        <div className="relative flex-1">
                            ...
                            <input
                                ...
                                className="w-full pl-10 pr-4 py-2.5 rounded-xl border border-slate-200 bg-slate-50 text-sm font-medium text-slate-900 focus:ring-2 focus:ring-teal-500/20 focus:border-teal-500 transition-all placeholder:text-slate-400"
                            />
                            {searchQuery && (
                        ...
                        <div className="flex items-center gap-2 shrink-0">
                            <button
                                ...
                                className={`flex items-center gap-2 px-3 py-2.5 rounded-xl border text-xs font-bold uppercase tracking-widest transition-all ${
                                    showFilters ? 'bg-teal-600 text-white border-teal-600' : 'bg-white text-slate-600 border-slate-200 hover:border-slate-300'
                                }`}
                            >
                            ...
                            <div className="relative">
                                <select
                                    ...
                                    className="appearance-none pl-3 pr-8 py-2.5 rounded-xl border border-slate-200 bg-white text-xs font-bold uppercase tracking-widest text-slate-600 cursor-pointer focus:ring-2 focus:ring-teal-500/20 focus:border-teal-500"
                                >
                            ...
                            <div className="flex border border-slate-200 rounded-xl overflow-hidden">
                                <button
                                    ...
                                    className={`p-2.5 ${viewMode === 'grid' ? 'bg-teal-600 text-white' : 'bg-white text-slate-400 hover:text-slate-600'}`}
                                >
                                    <Grid3X3 size={14} />
                                </button>
                                <button
                                    onClick={() => setViewMode('list')}
                                    className={`p-2.5 ${viewMode === 'list' ? 'bg-teal-600 text-white' : 'bg-white text-slate-400 hover:text-slate-600'}`}
                                >
                                    <List size={14} />
                                </button>
                            </div>
                    ...
                    <div className="flex gap-2 mt-3 overflow-x-auto pb-1 scrollbar-hide">
                        ...
                        <span className="px-3 py-1.5 text-[10px] text-slate-400 font-medium shrink-0">
                ...
                {filteredListings.length > 0 ? (
                    ...
                    <div className="bg-white rounded-2xl border border-slate-200 p-12 text-center">
                        ...
                        <button
                            ...
                            className="px-4 py-2 bg-teal-600 text-white rounded-xl text-xs font-bold uppercase tracking-widest hover:bg-teal-700 transition-colors"
                        >
                            Clear Filters
                        </button>
                    </div>
