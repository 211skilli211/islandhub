        ...
        return (
            <main className="min-h-screen bg-slate-50 flex items-center justify-center">
                <div className="text-center">
                    ...
                    <p className="text-slate-500 font-medium">Loading co-ops...</p>
                </div>
            </main>
        );
    }
            ...
            <section className="sticky top-0 z-20 bg-white border-b border-slate-200 shadow-sm">
                <div className="max-w-7xl mx-auto px-6 py-4">
                    <div className="flex flex-wrap items-center gap-4">
                        ...
                        {/* Island filter */}
                        <div className="flex items-center gap-2">
                            <span className="text-xs font-bold text-slate-400 uppercase tracking-wider">Island:</span>
                            <div className="flex gap-1">
            ...
            <section className="max-w-7xl mx-auto px-6 py-12">
                {groupedCoops.length === 0 ? (
                    <div className="text-center py-20">
                        ...
                        <h3 className="text-xl font-black text-slate-900 mb-2">No co-ops found</h3>
                    ...
                    groupedCoops.map((group, gi) => (
                        <div key={group.sector_key} className="mb-16">
                            <div className="flex items-center gap-3 mb-8">
                                ...
                                <div>
                                    <h2 className="text-2xl font-black text-slate-900 italic uppercase">{group.display_name}</h2>
                                ...
                                {group.coops.map((coop, ci) => (
                                    ...
                                    >
                                        <Link href={`/store/ibt-solutions/coops/${coop.slug}`}>
                                            <div className="bg-white rounded-2xl border border-slate-100 p-6 hover:shadow-xl hover:-translate-y-1 transition-all h-full group">
                                                ...
                                                <div className="flex items-center justify-between">
                                                    <div className="flex items-center gap-2">
                                                        ...
                                                        {coop.member_count !== undefined && (
                                                            <span className="text-xs bg-teal-50 text-teal-700 px-2 py-1 rounded-lg font-medium">
                                                                👥 {coop.member_count} members
                                                            </span>
                                                        )}
                                                    </div>
                                                    <span className="text-teal-600 text-xs font-bold group-hover:translate-x-1 transition-transform">
                                                        View →
                                                    </span>
                                                </div>
                                            </div>
            ...
            <section className="bg-slate-900 py-20 px-6">
                <div className="max-w-3xl mx-auto text-center">
                    ...
                    <Link
                        ...
                        className="inline-block px-8 py-4 bg-teal-600 text-white rounded-2xl font-bold uppercase text-sm tracking-wider hover:bg-teal-500 transition-all"
                    >
                        Apply to Join
                    </Link>
                </div>
