                ...
                <div className="max-w-6xl mx-auto">
                    <div className="flex justify-between items-start mb-6">
                        <div>
                            ...
                            <p className="text-theme-tertiary font-medium mt-1">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                        <div className="bg-theme-tertiary/10 backdrop-blur-md p-4 rounded-2xl border border-white/20">
                            <p className="text-[10px] uppercase font-black text-theme-tertiary tracking-widest">Today</p>
                            <p className="text-2xl font-black text-green-400">${earnings.today.toFixed(2)}</p>
                        </div>
                        <div className="bg-theme-tertiary/10 backdrop-blur-md p-4 rounded-2xl border border-white/20">
                            <p className="text-[10px] uppercase font-black text-theme-tertiary tracking-widest">This Week</p>
                            <p className="text-2xl font-black text-accent-400">${earnings.week.toFixed(2)}</p>
                        </div>
                        <div className="bg-theme-tertiary/10 backdrop-blur-md p-4 rounded-2xl border border-white/20">
                            <p className="text-[10px] uppercase font-black text-theme-tertiary tracking-widest">Active</p>
                            <p className="text-2xl font-black text-blue-400">{activeJobs.length}</p>
                        </div>
                        <div className="bg-theme-tertiary/10 backdrop-blur-md p-4 rounded-2xl border border-white/20">
                            <p className="text-[10px] uppercase font-black text-theme-tertiary tracking-widest">Completed</p>
                            <p className="text-2xl font-black text-teal-400">{completedJobs.length}</p>
                        </div>
                    </div>

                    
                    <div className="mt-6 flex gap-2 p-1 bg-theme-tertiary/50 backdrop-blur-md rounded-2xl border border-white/10">
                        {([
                            ...
                            <button
                                ...
                                className={`flex-1 py-3 px-4 rounded-xl text-xs font-black uppercase tracking-widest transition-all ${activeTab === tab.id
                                    ...
                                    : 'text-theme-tertiary hover:text-white hover:bg-theme-tertiary/5'
                                    }`}
                            >
            ...
            <div className="max-w-6xl mx-auto px-4 mt-6 space-y-4">
                ...
                {activeTab === 'available' && (
                    <div className="space-y-4">
                        {jobs.length === 0 ? (
                            <div className="text-center py-20 bg-theme-tertiary rounded-3xl border border-border-primary shadow-sm">
                                <EmojiIcon emoji="😴" size={48} className="text-6xl mb-4" />
                                <p className="font-bold text-theme-secondary">No jobs available for your vehicle.</p>
                                <p className="text-sm text-theme-tertiary mt-2">Check back soon or adjust your availability.</p>
                            </div>
                        ) : (
                            jobs.map(job => (
                                <div key={job.id} className="bg-theme-tertiary p-6 rounded-3xl border border-border-primary shadow-lg hover:shadow-xl transition-all relative overflow-hidden group">
                                    ...
                                    <div className="relative z-10">
                                        ...
                                        <h3 className="text-xl font-black text-theme-primary mb-2">{job.title}</h3>
                                        <p className="text-sm text-theme-tertiary mb-4 line-clamp-2">{job.description}</p>

                                        <div className="space-y-3 mb-6 bg-theme-primary p-4 rounded-xl">
                                            <div className="flex items-start gap-3">
                                                <div className="w-3 h-3 bg-green-500 rounded-full mt-1 flex-shrink-0" />
                                                <div className="flex-1">
                                                    <p className="text-[10px] text-theme-tertiary font-bold uppercase">Pickup</p>
                                                    <p className="text-sm font-bold text-theme-primary">{job.pickup_location}</p>
                                                </div>
                                            </div>
                                            <div className="w-0.5 h-4 bg-theme-tertiary ml-1.5" />
                                            <div className="flex items-start gap-3">
                                                <div className="w-3 h-3 bg-red-500 rounded-full mt-1 flex-shrink-0" />
                                                <div className="flex-1">
                                                    <p className="text-[10px] text-theme-tertiary font-bold uppercase">Dropoff</p>
                                                    <p className="text-sm font-bold text-theme-primary">{job.dropoff_location}</p>
                                                </div>
                                            </div>
                                        </div>
                ...
                {activeTab === 'active' && (
                    <div className="space-y-4">
                        {activeJobs.length === 0 ? (
                            <div className="text-center py-20 bg-theme-tertiary rounded-3xl border border-border-primary shadow-sm">
                                <EmojiIcon emoji="🎯" size={48} className="text-6xl mb-4" />
                                <p className="font-bold text-theme-secondary">No active jobs. Go get 'em!</p>
                            </div>
                        ) : (
                            activeJobs.map(job => (
                                <div key={job.id} className="bg-gradient-to-br from-white to-teal-50 p-6 rounded-3xl border-2 border-teal-200 shadow-xl relative overflow-hidden">
                                    <div className="flex justify-between items-start mb-6">
                                        <div>
                                            ...
                                            <h3 className="text-xl font-black text-theme-primary">{job.title}</h3>
                                            <p className="text-sm text-theme-secondary mt-1">{job.pickup_location} → {job.dropoff_location}</p>
                                        </div>
                                    ...
                                    <div className="grid grid-cols-2 gap-3 mb-6">
                                        <button
                                            ...
                                            className={`py-3 rounded-xl font-black uppercase text-xs tracking-widest border-2 transition-all ${job.transport_status === 'in_progress'
                                                ...
                                                : 'bg-theme-tertiary text-[#14b8a6] border-[#14b8a6]/20 hover:bg-[#14b8a6]/10'
                                                }`}>
                                            🚗 Start / En Route
                                        </button>
                                        <button
                                    ...
                                    <div className="bg-theme-tertiary/80 backdrop-blur-sm p-4 rounded-xl text-center border border-teal-200">
                                        <p className="text-[10px] text-theme-tertiary font-bold uppercase mb-2">Navigation</p>
                                        <a
                ...
                {activeTab === 'earnings' && (
                    <div className="space-y-6">
                        ...
                        <div className="bg-theme-tertiary p-8 rounded-3xl border border-border-primary shadow-xl">
                            <h3 className="text-2xl font-black text-theme-primary mb-6">Earnings Breakdown</h3>
                            <div className="space-y-4">
                                <div className="flex justify-between items-center p-4 bg-theme-primary rounded-2xl">
                                    <span className="font-bold text-theme-secondary">This Month</span>
                                    <span className="text-2xl font-black text-accent-400">${earnings.month.toFixed(2)}</span>
                                </div>
                                <div className="flex justify-between items-center p-4 bg-theme-primary rounded-2xl">
                                    <span className="font-bold text-theme-secondary">Total Lifetime</span>
                                    <span className="text-2xl font-black text-[#14b8a6]">${earnings.total.toFixed(2)}</span>
                                </div>
                                <div className="flex justify-between items-center p-4 bg-theme-primary rounded-2xl">
                                    <span className="font-bold text-theme-secondary">Average per Job</span>
                ...
                {activeTab === 'vehicles' && (
                    <div className="space-y-6">
                        <div className="bg-theme-tertiary p-8 rounded-3xl border border-border-primary shadow-xl">
                            <h3 className="text-2xl font-black text-theme-primary mb-6">Manage My Fleet & Services</h3>

                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                
                                <div className="space-y-4">
                                    <h4 className="text-sm font-black text-theme-tertiary uppercase tracking-widest">Active Vehicle</h4>
                                        ...
                                        {[
                                            ...
                                            <button
                                                ...
                                                className={`p-4 rounded-2xl border-2 transition-all flex flex-col items-center gap-2 ${user?.vehicle_type === v.id
                                                    ...
                                                    : 'border-border-primary bg-theme-primary hover:border-teal-200'
                                                    }`}>
                                ...
                                <div className="space-y-4">
                                    <h4 className="text-sm font-black text-theme-tertiary uppercase tracking-widest">Services Offered</h4>
                                    <div className="space-y-3">
                                        {[
                                            ...
                                            <div key={s.id} className="flex items-center justify-between p-4 bg-theme-primary rounded-2xl border border-border-primary">
                                                <div className="flex items-center gap-3">
                                                    <span className="text-xl">{s.icon}</span>
                                                    <span className="font-bold text-theme-secondary">{s.label}</span>
                                                </div>
                                                <div className="relative inline-block w-10 mr-2 align-middle select-none">
                                                    <input type="checkbox" name="toggle" id={s.id} readOnly checked className="toggle-checkbox absolute block w-6 h-6 rounded-full bg-theme-tertiary border-4 appearance-none cursor-pointer border-teal-500 checked:right-0 right-4 transition-all duration-200" />
                                                    <label htmlFor={s.id} className="toggle-label block overflow-hidden h-6 rounded-full bg-accent-500/100 cursor-pointer"></label>
                                                </div>
                                            </div>
                                        ))}
                                    </div>
                                    <p className="text-[10px] text-theme-tertiary font-medium italic">
                        ...
                        <div className="bg-gradient-to-br from-teal-700 to-teal-900 p-8 rounded-3xl text-white shadow-2xl overflow-hidden relative">
                            <div className="relative z-10">
                                ...
                                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                                    <div className="bg-theme-tertiary/10 backdrop-blur-md p-4 rounded-xl">
                    ...
                    <div className="space-y-6">
                        <div className="bg-theme-tertiary p-8 rounded-3xl border border-border-primary shadow-xl">
                            <div className="flex items-center gap-6 mb-8">
                                ...
                                <div>
                                    <h2 className="text-3xl font-black text-theme-primary">{user?.name}</h2>
                                    <p className="text-theme-tertiary font-medium">{user?.email}</p>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div className="p-6 bg-theme-primary rounded-2xl">
                                    <h3 className="font-black text-theme-primary mb-4 uppercase tracking-widest text-xs">Driver Stats</h3>
                                    <div className="space-y-3">
                                        <div className="flex justify-between">
                                            <span className="text-theme-secondary font-medium">Total Jobs</span>
                                            <span className="font-black text-theme-primary">{completedJobs.length}</span>
                                        </div>
                                        <div className="flex justify-between">
                                            <span className="text-theme-secondary font-medium">Active Jobs</span>
                                            <span className="font-black text-blue-600">{activeJobs.length}</span>
                                        </div>
                                        <div className="flex justify-between">
                                            <span className="text-theme-secondary font-medium">Total Earned</span>
                                ...
                                <div className="p-6 bg-theme-primary rounded-2xl">
                                    <h3 className="font-black text-theme-primary mb-4 uppercase tracking-widest text-xs">Vehicle Info</h3>
                                    <div className="space-y-3">
                                        <div className="flex justify-between">
                                            <span className="text-theme-secondary font-medium">Type</span>
                                            <span className="font-black text-theme-primary capitalize">{user?.vehicle_type || 'Not Set'}</span>
                                        </div>
                                        <div className="flex justify-between">
                            ...
                            <div className="mt-6 flex flex-col sm:flex-row gap-4">
                                <Link
                                    href={`/users/${user?.id}`}
                                    className="px-6 py-3 bg-theme-tertiary text-white rounded-xl text-xs font-black uppercase tracking-widest hover:bg-theme-tertiary transition-all text-center"
                                >
                                    View Public Profile 👤
                                </Link>
