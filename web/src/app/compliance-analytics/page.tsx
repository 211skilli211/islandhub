...
export default function ComplianceAnalyticsPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-black text-slate-900">Compliance Analytics</h1>
        <p className="text-sm text-slate-500 mt-1">Overview of compliance metrics and system health</p>
      </div>
