    ...
    return (
        ...
        >
            <Link
                ...
                className="group block bg-white rounded-3xl overflow-hidden hover:shadow-2xl transition-all duration-300"
            >
                {/* Large Image */}
                <div className="relative aspect-[4/3] overflow-hidden rounded-3xl">
                    ...
                    {/* Category badge */}
                    <div className="absolute top-3 left-3 bg-white/90 backdrop-blur-sm px-2.5 py-1 rounded-full text-[11px] font-bold text-slate-700 flex items-center gap-1 shadow-sm">
                    ...
                    <div className="absolute bottom-3 left-3 right-3 flex items-end justify-between">
                        <div className="bg-white/95 backdrop-blur-sm rounded-xl px-3 py-1.5 shadow-sm">
                            <span className="text-lg font-black text-slate-900">${(Math.floor(Math.random() * 200) + 45)}</span>
                ...
                <div className="px-1 pt-3 pb-1">
                    ...
                    <div className="flex items-start gap-1.5 mb-1">
                        ...
                        <h3 className="text-[15px] font-bold text-slate-900 group-hover:text-rose-600 transition-colors line-clamp-1 leading-tight">{storeName}</h3>
                    </div>

                    {/* Description */}
                    <p className="text-xs text-slate-400 line-clamp-1 mb-2 pl-5">
...
export default function RentalsHubPage() {
    ...
    return (
        <main className="min-h-screen bg-white">
                    ...
                    <div className="bg-white rounded-full p-2 shadow-2xl flex items-center gap-2 max-w-2xl mx-auto">
                        <div className="flex-1 flex items-center gap-3 px-5">
                            ...
                            <input
                                ...
                                className="w-full py-2.5 text-slate-900 font-medium placeholder-slate-400 focus:outline-none text-sm bg-transparent"
                            />
                        </div>
            ...
            <section className="bg-white/80 backdrop-blur-md border-b border-rose-100 sticky top-0 z-30 mt-8">
                                ...
                                <button
                                    ...
                                    className={`inline-flex items-center gap-2 px-5 py-2.5 rounded-full text-sm font-semibold transition-all whitespace-nowrap border ${
                                        isActive
                                            ...
                                            : 'bg-white text-slate-600 border-slate-200 hover:border-rose-200 hover:bg-rose-50 hover:text-rose-600'
                                    }`}
                                >
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
                {!loading && totalStores === 0 && (
                    <div className="text-center py-24">
                        ...
                        <h3 className="text-2xl font-bold text-slate-900 mb-3">No rentals found</h3>
                        <p className="text-slate-400 mb-8 max-w-md mx-auto">Try adjusting your search or browse all categories to discover island rentals.</p>
                        <button
                    ...
                    !loading && totalStores > 0 && (
                        <div>
                            <div className="flex items-center justify-between mb-6">
                                ...
                                <span className="text-sm text-slate-400 font-medium">{totalStores} rentals found</span>
                            </div>
                                    ...
                                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                                        {[1, 2, 3].map(i => (
                                            <div key={i} className="animate-pulse">
                                                <div className="aspect-[4/3] bg-slate-100 rounded-3xl mb-3" />
            ...
            <section className="relative overflow-hidden">
                ...
                <div className="relative max-w-4xl mx-auto text-center py-20 px-6">
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                        <Link
                            href="/become-vendor"
                            className="inline-flex items-center gap-2 px-10 py-4 bg-white text-rose-600 font-bold rounded-full hover:bg-rose-50 transition-all shadow-2xl text-sm uppercase tracking-wider hover:scale-105 transform duration-200"
                        >
                            Start Hosting Today
                            <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}>
