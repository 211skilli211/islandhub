                ...
                {loading ? (
                    ...
                    <div className="text-center py-24 bg-surface-primary rounded-[3rem] border-2 border-dashed border-border-primary">
                        ...
                        <button
                            ...
                            className="mt-4 px-6 py-2 bg-[#14b8a6] text-white rounded-xl font-bold uppercase text-[10px] tracking-widest"
                        >
                            Reset Search
                        </button>
                    </div>
                        ...
                        {filteredVendors.map((vendor, idx) => (
                            ...
                            >
                                <Link
                                    ...
                                    className="block p-8 bg-surface-elevated rounded-[2.5rem] border border-border-primary hover:shadow-2xl hover:shadow-teal-200 hover:-translate-y-2 transition-all group"
                                >
