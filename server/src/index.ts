...
import ticketedEventRoutes from './routes/ticketedEvents';
import webhookRoutes from './routes/webhookRoutes';
import paypalRoutes from './routes/paypalRoutes';
import cryptoPaymentRoutes from './routes/cryptoPayments';
...
import aiGenerationRoutes from './routes/aiGenerationRoutes';
import visualSearchRoutes from './routes/visualSearchRoutes';
...
app.use('/api/events', ticketedEventRoutes);
...
app.use('/api/visual', visualSearchRoutes);
